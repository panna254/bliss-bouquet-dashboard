  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-elegant focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-card-hover transform hover:scale-105 transition-bounce shadow-elegant",
        accent: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-soft hover:shadow-medium",
        premium: "bg-gradient-secondary text-secondary-foreground hover:shadow-card-hover transform hover:scale-105 transition-bounce shadow-elegant border border-accent/20",
      },
      size: {
